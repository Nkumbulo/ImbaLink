...
/** Supabase implementation of ImbaLink's business credential sign-in. */
export const supabaseBusinessAuthAdapter = Object.freeze({
  async signInWithCredentials(username, password) {
    ...
    if (sessionError || !sessionData.session) {
      throw sessionError || new Error("AUTH_SESSION_INVALID");
    }

...
export const THEMES = [
  { id: "classic", name: "Imba Green", description: "The signature ImbaLink green", color: "#2F7A55", soft: "#E7F0EA", deep: "#204F3A", surface: "#FBF8F0", surface2: "#F1EBDB", surface3: "#E9E1CB", ink: "#14201A", muted: "#62695F", line: "#E7DFC9", navText: "#FFFFFF" },
  { id: "ocean", name: "Coastal Blue", description: "Fresh blue with a calm, modern feel", color: "#287C86", soft: "#E4F1F2", deep: "#1D5961", surface: "#F7FAF9", surface2: "#EAF2F1", surface3: "#DDEAE8", ink: "#142325", muted: "#617073", line: "#D8E4E2", navText: "#FFFFFF" },
  { id: "blush", name: "Blush Rose", description: "A soft feminine rose palette with warm neutrals", color: "#B85C7A", soft: "#F8E8EE", deep: "#873F5A", surface: "#FFF9FA", surface2: "#F7ECEF", surface3: "#F0DEE5", ink: "#2B1D24", muted: "#75666D", line: "#EAD7DE", navText: "#FFFFFF" },
  { id: "midnight", name: "Imba Midnight", description: "Apple-inspired liquid glass dark theme built around #14201A", color: "#14201A", soft: "#31453B", deep: "#0D1511", surface: "#1B2822", surface2: "#24352D", surface3: "#111A16", ink: "#F4F8F5", muted: "#AEBBB3", line: "rgba(255,255,255,.13)", navText: "#FFFFFF" },
];
